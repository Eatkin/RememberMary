...
for (var i=0; i<selectionMax+1; i+=1)
	draw_text(xdraw,ydraw+spacing*i,option[i]);
	
xdraw+=string_width(option[0]);		//This is the longest options name
xdraw+=96;
...
//Draw notes
draw_text(128,160,"This is required for mobile devices");
